...
//CODE HERE
let amysName = "Amy";
let brittanisName = "Brittanis";
if (amysAge === brittanisAge) {
  console.log(`${amysName} and ${brittanisName} are the same age.`);
...
if (amysBirthYear === brittanisBirthYear) {
  console.log(`${amysName} and ${brittanisName} have the same birth year.`);
}else{
  console.log(`${amysName} and ${brittanisName} were not born in the same year.`);
}
...
if (rain === true && temperature >= 80) {
  ...
  console.log("You should wear a coat and take and umbrella.");
